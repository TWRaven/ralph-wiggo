...
- Add a new Go package with types and functions
- Add a CLI subcommand with flag parsing
...
2. Internal packages / backend logic
...
6. **Always add**: "go vet ./... passes" to every story's acceptance criteria
...
- [ ] Every story has "go vet ./... passes" as criterion
